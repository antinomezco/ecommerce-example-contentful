  ...
  return (
    <>
        ...
        <div className="overflow-x-hidden">
          <section className="bg-[url('../assets/home/mobile/image-header.jpg')] md:bg-[url('../assets/home/tablet/image-header.jpg')] lg:bg-[url('../assets/home/desktop/image-hero.jpg')] min-h-[600px] md:min-h-[729px] bg-bottom bg-cover grid items-center grid-cols-12">
            <div className="grid col-span-10 col-start-2 md:col-span-6 md:col-start-4 lg:col-start-2 lg:col-span-5 mx-auto lg:mx-0 lg:w-11/12 text-center lg:text-left space-y-4">
              ...
              <h1 className="tw-body text-white">
