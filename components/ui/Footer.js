...
export default function Footer(data) {
  return (
    <footer className="bg-black relative">
      ...
      <div className="w-11/12 py-12 mx-auto space-y-8 lg:w-10/12">
        <div className="space-y-8 lg:flex lg:justify-between lg:space-y-0">
        ...
        <div className="tw-body text-white/50 text-center lg:w-6/12 lg:text-left">
        ...
        <div className="space-y-4 md:space-y-0 md:flex md:items-center md:justify-between">
          <div className="tw-body text-white/50 text-center">
