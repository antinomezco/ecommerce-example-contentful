...
export default function Header() {
  ...
  return (
    <div className="border-b border-gray-400 py-8 bg-black">
      <nav className="flex w-11/12 lg:w-10/12 mx-auto justify-between md:justify-start lg:justify-between md:space-x-8 lg:space-x-0 items-center">
        {/* MOBILE-MENU */}
